...
parser.add_argument('--input', help='Path to input image.', default='sc_0.959_C_DWHXJ_947_1778_1213_2047_.jpg')
...
tt = cv.findContours(bw, cv.RETR_LIST, cv.CHAIN_APPROX_NONE)
